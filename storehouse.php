...
?>
    ...
    <div class="content">
        ...
        <div>
            В данном разделе представлена информация о наличии складских остатков,выставленных на продажу.
            Уточнить цену и другие вопросы можно связавшись с нами по телефонам :
        </div>
        <br>
        <div>
            +7 (495) 543-91-93
        ...
        <div class="help-block">
            03.02.2018г. Изменены контактные данные
        </div>

        <div class="help-block">
            03.09.2015г. Добавлены фото патрона токарного С 7100-0039П 315мм
        </div>

        <div class="help-block">
            06.08.2015г.Добавлены позиции по разделу "Патроны токарные"
        </div>

        <div class="help-block">
            28.07.2015г.Добавлены позиции по разделу "Муфты"
        </div>

        <div class="help-block">
            28.07.2015г.Добавлены позиции по разделу "Оборудование Delta Tau"
        </div>
        <br>
        ...
        <div class="row table-bordered" style="padding: 10px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <hr>
                <b>ИНСТРУМЕНТАЛЬНЫЙ ДИСК К РЕВОЛЬВЕРНОЙ ГОЛОВКЕ DUPLOMATIC BSV-N200</b>
                <br>
                ...
                <div id="hide-me1" class="collapse">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td>ИНСТРУМЕНТАЛЬНЫЙ ДИСК К РЕВОЛЬВЕРНОЙ ГОЛОВКЕ DUPLOMATIC BSV-N200</td>
                        </tr>
                        <tr>
                    ...
                    <div>
                        Количество: 2шт - Состояние : Отличное
                    </div>
                    <br>
        ...
        <div class="row table-bordered" style="padding: 10px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <hr>
                <b>ШВП ДЛЯ ВЕРТИКАЛЬНО-ФРЕЗЕРНОГО СТАНКА МОД. ГФ2171</b>
                <br>
                <i>есть в наличии.</i>
                <hr>
                ...
                <div id="hide-me2" class="collapse">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <th scope="row">Модель:</th>
                            <td>ШВП ДЛЯ ВЕРТИКАЛЬНО-ФРЕЗЕРНОГО СТАНКА МОД. ГФ2171</td>
                        </tr>
                        <tr>
                            <th scope="row">Год выпуска:</th>
                            <td></td>
                    ...
                    <div>
                        Ось Z , кол-во : 9 шт. возможна установка на станок 6Т13.
                    </div>
                    <br>

                    <div>
                        Количество: 6 шт - законсервированы, 3шт - б\у.
                    </div>
                    <br>
        ...
        <div class="row table-bordered" style="padding: 10px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <hr>
                <b>ШВП ДЛЯ ТОКАРНОГО СТАНКА 16М30Ф3</b>
                <br>
                ...
                <div id="hide-me3" class="collapse">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <th scope="row">Модель:</th>
                            <td>ШВП ДЛЯ ТОКАРНОГО СТАНКА 16М30Ф3</td>
                        </tr>
                        <tr>
                            <th scope="row">Год выпуска:</th>
                            <td></td>
                    ...
                    <div>
                        Количество : 4 шт - б\у. Без гайки. Состояние - отличное/
                    </div>
                    <br>
        ...
        <div class="row table-bordered" style="padding: 10px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <hr>
                <b>ШВП ДЛЯ ТОКАРНО-РЕВОЛЬВЕРНОГО СТАНКА 1В340</b>
                <br>
                <i>есть в наличии, кол-во : 2 шт.</i>
                <hr>
                ...
                <div id="hide-me4" class="collapse">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <th scope="row">Модель:</th>
                            <td>ШВП ДЛЯ ТОКАРНО-РЕВОЛЬВЕРНОГО СТАНКА 1В340</td>
                        </tr>
                        <tr>
                            <th scope="row">Год выпуска:</th>
                            <td></td>
                    ...
                    <div>
                        Количество : 2 шт. - б\у. Состояние - хорошее.
                    </div>
                    <br>
        ...
        <div class="row table-bordered" style="padding: 10px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <hr>
                <b>ШВП ДЛЯ ТОКАРНОГО СТАНКА 16К20T1 530100</b>
                <br>
                <i>есть в наличии.</i>
                <hr>
                ...
                <div id="hide-me5" class="collapse">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <th scope="row">Модель:</th>
                            <td>ШВП ДЛЯ ТОКАРНОГО СТАНКА 16К20T1 530100</td>
                        </tr>
                        <tr>
                            <th scope="row">Год выпуска:</th>
                            <td></td>
                    ...
                    <div>
                        Количество : 1 шт. - б\у. Состояние - Хорошее.
                    </div>
                    <br>

                    <button class="btn btn-success" data-toggle="collapse" data-target="#hide-me5_1">Показать другие изображения</button>
        ...
        <div class="row table-bordered" style="padding: 10px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <hr>
                <b>ШВП ДЛЯ ТОКАРНО-ВИНТОРЕЗНОГО СТАНКА 1М63</b>
                <br>
                <i>есть в наличии.</i>
                <hr>
                ...
                <div id="hide-me6" class="collapse">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <th scope="row">Модель:</th>
                            <td>ШВП ДЛЯ ТОКАРНО-ВИНТОРЕЗНОГО СТАНКА 1М63</td>
                        </tr>
                        <tr>
                            <th scope="row">Год выпуска:</th>
                            <td></td>
                    ...
                    <div>
                        Количество : 1 шт. - законсервировано.
                    </div>
                    <br>
        ...
        <div class="row table-bordered" style="padding: 10px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <hr>
                <b>ШВП ДЛЯ ТОКАРНО-РЕВОЛЬВЕРНОГО СТАНКА МОД. 1325</b>
                <br>
                <i>есть в наличии.</i>
                <hr>
                ...
                <div id="hide-me7" class="collapse">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <th scope="row">Модель:</th>
                            <td>ШВП ДЛЯ ТОКАРНО-РЕВОЛЬВЕРНОГО СТАНКА МОД. 1325</td>
                        </tr>
                        <tr>
                            <th scope="row">Год выпуска:</th>
                            <td></td>
